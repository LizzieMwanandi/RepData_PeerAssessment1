...
```
## Warning in download.file(activity_URL, "./Data2021/Activity.zip"): InternetOpenUrl failed:
## 'The server name or address could not be resolved'
```

```
## Error in download.file(activity_URL, "./Data2021/Activity.zip"): cannot open URL 'https://d396qusza40orc.cloudfront.net/repdata%2Fdata%2Factivity.zip'
```
...
```
## Warning in unzip("./Data2021/Activity.zip", exdir = "./Data2021/Activity"): error 1 in
